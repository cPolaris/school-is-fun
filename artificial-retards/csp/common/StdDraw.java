...
//        frame.addKeyListener(std);    // JLabel cannot get keyboard focus
        ...
        frame.setTitle("CS 440 Assignment 2");
    ...
    ***************************************************************************/
    ...
    public static void setMouseListener(MouseListener lsn) {
        MouseListener[] lsns = draw.getMouseListeners();
        for (MouseListener mouseLsnr : lsns) {
            draw.removeMouseListener(mouseLsnr);
        }
        draw.addMouseListener(lsn);
    }
